# Day 2 Normalized Draft Question Bank
...
Spec: `docs/Pilot1/aip-c01/exam-prep/question-bank-specification.md`

## Summary

- Normalized candidate count: 131
- Raw parse errors: 0
...
| `source_trace_status` | needs-source-check |
...
Generation notes: Scenario tests root-cause-first principles; reviewer should check coverage of Glue Data Quality warning signals.

### P1-AIP-D2-N002

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N002 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
| `last_reviewed` | not-reviewed |
| `source_trace_status` | needs-source-check |
| `raw_source` | 2026-06-23T051527Z-openai-gpt-4.1-day-02-order001.md item 2 |
| `raw_provider` | openai |
| `raw_model` | gpt-4.1 |
| `raw_created_utc` | 2026-06-23T051527Z |
| `raw_run_id` | order001 |
...
1. AWS Glue Data Quality integrated with Amazon CloudWatch metrics
2. AWS Lambda and Step Functions state machine for anomaly detection
3. Amazon SageMaker Studio classic data profiler
4. Custom CloudWatch alarms configured on S3 PutObject events

Correct answer: AWS Glue Data Quality integrated with Amazon CloudWatch metrics

Rationale: Glue Data Quality provides comprehensive anomaly detection and data profiling, with metric publication to CloudWatch for alerting integration.

Distractors: AWS Lambda and Step Functions state machine for anomaly detection: Lambda/StepFunctions can automate custom logic but lack built-in data quality profiling and easy integration to metrics.; Amazon SageMaker Studio classic data profiler: SageMaker Studio provides interactive profiling and is not recommended for production pipeline automation or real-time alerts.; Custom CloudWatch alarms configured on S3 PutObject events: Alarms on object upload events don't check content quality; they only detect file arrival.

Misconception tags: Picking manual or interactive profiling over automated pipeline quality; Confusing file presence with data quality

Source trace:

AWS Glue Data Quality and CloudWatch documentation; study guide

Remediation target:

docs/Pilot1/aip-c01/student-kit/accelerated-7-day/study-guides/day-02-data-embeddings-vector-stores-rag.md

Generation notes: Tests mapping of Glue Data Quality + CloudWatch; reviewer should confirm automation and event-based alerting alignment.

### P1-AIP-D2-N003

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N003 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Scenario checks Data Wrangler profiling vs Raw S3; reviewer should confirm Data Wrangler profiling scope.

### P1-AIP-D2-N004

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N004 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Tests candidate’s ability to connect Glue rules + automated remediation; reviewer should inspect Lambda / Glue roles.

### P1-AIP-D2-N005

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N005 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Tests referential integrity enforcement in Glue; reviewer should verify that answer is not specific to S3 management.

### P1-AIP-D2-N006

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N006 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Emphasizes Glue Data Quality to CloudWatch pipeline; reviewer to confirm real-time monitoring boundary.

### P1-AIP-D2-N007

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N007 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Scenario differentiates managed vs custom/manual; reviewer should check orchestration claim.

### P1-AIP-D2-N008

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N008 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Judgment on when to apply validation vs tuning/retraining; reviewer should check policy boundaries.

### P1-AIP-D2-N009

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N009 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Focuses on transition from custom Lambda to managed data validation; reviewer should check viability of Glue DQ for replacement.

### P1-AIP-D2-N010

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N010 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Focus: always diagnose data first; reviewer to check coverage of data profiling importance.

### P1-AIP-D2-N011

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N011 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Multi-source scenario requiring integration of validation and deduplication; reviewer to check distinctions from simple monitoring.

### P1-AIP-D2-N012

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N012 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Genomics/high-volume edge case; reviewer should confirm Glue's ability to check delimiter/schema at scale.

### P1-AIP-D2-N013

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N013 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Edge case: spike-handling and versioning; reviewer should validate Glue DQ's logging/reporting on ingestion.

### P1-AIP-D2-N014

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N014 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Scenario: scanned PDFs for procurement; check clarity on image preprocessing benefits.

### P1-AIP-D2-N015

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N015 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
| `last_reviewed` | not-reviewed |
| `source_trace_status` | needs-source-check |
| `raw_source` | 2026-06-23T051621Z-openai-gpt-4.1-day-02-order002.md item 2 |
| `raw_provider` | openai |
| `raw_model` | gpt-4.1 |
| `raw_created_utc` | 2026-06-23T051621Z |
| `raw_run_id` | order002 |
...
A data scientist is designing a pipeline to convert podcast audio files into text summaries using an FM. What is the most suitable service to use for automated audio-to-text conversion in this workflow?
...
Correct answer: AWS Transcribe

Rationale: AWS Transcribe is specifically designed for transcribing audio into text, making it the correct preprocessing step before feeding data into an FM for summarization.

Distractors: Amazon Comprehend: Amazon Comprehend is used for NLP tasks on text data, not audio transcription.; Amazon Polly: Amazon Polly is used for text-to-speech, the inverse of what is needed (audio-to-text).; AWS Glue: AWS Glue is a data integration and ETL service, not specifically designed for audio-to-text conversion.

Misconception tags: Confusing NLP with audio transcription; Confusing ETL with preprocessing

Source trace:

source: requirement for correct upstream audio-to-text conversion service

Remediation target:

docs/Pilot1/aip-c01/student-kit/accelerated-7-day/day-02-artifacts/day-02-answer-guidance.md

Generation notes: Audio file scenario; reviewer should ensure no trivia and all options are scenario-relevant.

### P1-AIP-D2-N016

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N016 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
| `last_reviewed` | not-reviewed |
| `source_trace_status` | needs-source-check |
| `raw_source` | 2026-06-23T051621Z-openai-gpt-4.1-day-02-order002.md item 3 |
| `raw_provider` | openai |
| `raw_model` | gpt-4.1 |
| `raw_created_utc` | 2026-06-23T051621Z |
| `raw_run_id` | order002 |
...
A data engineering team must preprocess a diverse dataset comprising text documents, medical x-ray images, and call center audio recordings for an FM-enabled analytics system. Which AWS services and architectural components should be included to handle preprocessing for each data type? (Select TWO that apply.)

Options:

1. Use AWS Transcribe to generate transcripts from audio recordings.
2. Use Amazon Rekognition for extracting structured text from x-ray images.
3. Use a SageMaker Processing job for text cleansing and normalization.
4. Use AWS Glue to extract tabular data from x-ray images.
5. Use Amazon Polly to convert text documents to speech.

Correct answer: Use AWS Transcribe to generate transcripts from audio recordings.; Use a SageMaker Processing job for text cleansing and normalization.

Rationale: AWS Transcribe is designed for audio-to-text conversion, and SageMaker Processing can handle scalable text preprocessing tasks, aligning with the requirements for audio and text data types.

Distractors: Use Amazon Rekognition for extracting structured text from x-ray images.: Amazon Rekognition doesn't specialize in processing x-rays nor extracting structured text from medical images, which likely require custom image processing pipelines.; Use AWS Glue to extract tabular data from x-ray images.: AWS Glue is for tabular data ETL, but it cannot extract data from medical images directly.; Use Amazon Polly to convert text documents to speech.: Polly is for text-to-speech, which is not required for the workflow (speech synthesis is unnecessary for this analytics system).

Misconception tags: Service misuse; Confusing NLP, CV, TTS

Source trace:

source: AWS service boundaries for preprocessing media types

Remediation target:

docs/Pilot1/aip-c01/student-kit/accelerated-7-day/study-guides/day-02-data-embeddings-vector-stores-rag.md

Generation notes: Covers text, audio, image; reviewer should verify service fit for each media type.

### P1-AIP-D2-N017

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N017 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Tabular-to-JSON scenario; check option boundaries are precise.

### P1-AIP-D2-N018

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N018 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Examines omission due to missing diagram extraction; reviewer should confirm extraction recommendation.

### P1-AIP-D2-N019

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N019 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Pipeline covers three data types; reviewer must check if clarity on base64 and normalization is adequate.

### P1-AIP-D2-N020

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N020 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Scenario is OCR artifacts; reviewer must check if stem is clear and options are nuanced.

### P1-AIP-D2-N021

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N021 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
| `last_reviewed` | not-reviewed |
| `source_trace_status` | needs-source-check |
| `raw_source` | 2026-06-23T051621Z-openai-gpt-4.1-day-02-order002.md item 8 |
| `raw_provider` | openai |
| `raw_model` | gpt-4.1 |
| `raw_created_utc` | 2026-06-23T051621Z |
| `raw_run_id` | order002 |
...
You are building a pipeline to process incoming video files and need to extract both audio and image frames for FM-based content analysis. Which service combination will meet the preprocessing requirements most efficiently?

Options:

1. Use Amazon Rekognition for image frame extraction and AWS Transcribe for audio transcription.
2. Use Amazon Polly for audio extraction and AWS Glue for image extraction.
3. Use AWS Transcribe alone for both audio and video extraction.
4. Use Amazon Textract for analyzing image frames and extracting audio tracks.

Correct answer: Use Amazon Rekognition for image frame extraction and AWS Transcribe for audio transcription.

Rationale: Rekognition is designed for image/video frame analysis; Transcribe is for audio-to-text conversion. Together, they efficiently cover both key preprocessing needs.

Distractors: Use Amazon Polly for audio extraction and AWS Glue for image extraction.: Polly is text-to-speech, not extraction; Glue is for ETL, not image analysis.; Use AWS Transcribe alone for both audio and video extraction.: Transcribe only handles audio-to-text, not image frame extraction.; Use Amazon Textract for analyzing image frames and extracting audio tracks.: Textract analyzes document images for text, not audio or general frame extraction.

Misconception tags: Tool/service-function confusion; Overgeneralizing service capability

Source trace:

source: AWS Rekognition and Transcribe documentation

Remediation target:

docs/Pilot1/aip-c01/student-kit/accelerated-7-day/day-02-artifacts/day-02-answer-guidance.md

Generation notes: Ingests video for FM; reviewer to check that both modalities are mapped to right service.

### P1-AIP-D2-N022

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N022 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Scenario covers all four data modalities and input prep error; reviewer to check for any ambiguity in error source.

### P1-AIP-D2-N023

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N023 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Scenario covers PDF with text and images; reviewer to check that options address image+text separately.

### P1-AIP-D2-N024

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N024 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Multi-step pipeline for tickets; options must clarify preprocessing vs. aggregation.

### P1-AIP-D2-N025

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N025 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Social, image, voice; reviewer to check service alignment with data types.

### P1-AIP-D2-N026

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N026 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Scenario requires examinee to understand Bedrock API input constraints; quality risk is shallow recall if not tightly bound to service specifics.

### P1-AIP-D2-N027

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N027 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Date normalization scenario tests knowledge of standardization role before FM; reviewer should check real-world Lambda/ISO 8601 fit.

### P1-AIP-D2-N028

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N028 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Covers numeric/text normalization for SageMaker endpoint ingestion.

### P1-AIP-D2-N029

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N029 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Tests debugging input normalization as a root cause; requires process-of-elimination.

### P1-AIP-D2-N030

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N030 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Scenario targets structural migration from flat history to role-based formatting.

### P1-AIP-D2-N031

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N031 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Focuses on entity normalization as a pre-processing step for better FM summarization outcomes.

### P1-AIP-D2-N032

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N032 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Covers text cleaning and schema alignment; scenario is news classification via Bedrock API.

### P1-AIP-D2-N033

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N033 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Prompts roles of formatting utilities over manual concatenation; reviewer should check Bedrock documentation.

### P1-AIP-D2-N034

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N034 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Integration of tabular data preparation for ML/AI endpoints.

### P1-AIP-D2-N035

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N035 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Checks understanding of normalization tradeoffs; risk is lack of nuance in candidate.

### P1-AIP-D2-N036

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N036 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Tests impact of preprocessing bugs on downstream inference results.

### P1-AIP-D2-N037

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N037 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Covers correct input formatting versus common JSON parsing errors.

### P1-AIP-D2-N038

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N038 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
...
Generation notes: Scenario: Mixed technical & creative data; reviewer should check the distinction between relevance-driven and technical capability-driven model selection.

### P1-AIP-D2-N039

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N039 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario: Similar product names confused; inspect if model separation in embedding space is a root cause.

### P1-AIP-D2-N040

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N040 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
| `last_reviewed` | not-reviewed |
| `source_trace_status` | needs-source-check |
| `raw_source` | 2026-06-23T051804Z-openai-gpt-4.1-day-02-order004.md item 3 |
| `raw_provider` | openai |
| `raw_model` | gpt-4.1 |
| `raw_created_utc` | 2026-06-23T051804Z |
| `raw_run_id` | order004 |
...
You are tasked with deploying a cross-lingual semantic search system using an Amazon Bedrock embedding model. What limitation must you most carefully account for in such a system?

Options:

1. The embedding model must be explicitly trained or validated for all supported languages to produce consistent embeddings.
2. Vector dimensions must be different for each language.
3. Cosine similarity is not a valid similarity metric for comparing cross-lingual embeddings.
4. The model will automatically translate queries to the target document language.

Correct answer: The embedding model must be explicitly trained or validated for all supported languages to produce consistent embeddings.

Rationale: For cross-lingual search to work, the underlying model must produce compatible embeddings across languages; otherwise, semantic similarity across languages isn't reliable.

Distractors: Vector dimensions must be different for each language.: Embedding vectors should be of identical dimension for comparison across languages.; Cosine similarity is not a valid similarity metric for comparing cross-lingual embeddings.: Cosine similarity can still work if embeddings are in a shared space.; The model will automatically translate queries to the target document language.: Automatic translation is not typically built into embedding models; embeddings operate at the representation level, not as translators.

Misconception tags: Assuming multilingual support is always implicit; Confusing embedding models with machine translation

Source trace:

Amazon Bedrock & Titan embeddings multilingual capabilities documentation

Remediation target:

docs/Pilot1/aip-c01/student-kit/accelerated-7-day/study-guides/day-02-data-embeddings-vector-stores-rag.md

Generation notes: Scenario: Multilingual system design; reviewer should confirm true Bedrock model multilingual support limitations.

### P1-AIP-D2-N041

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N041 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
| `last_reviewed` | not-reviewed |
| `source_trace_status` | needs-source-check |
| `raw_source` | 2026-06-23T051804Z-openai-gpt-4.1-day-02-order004.md item 4 |
| `raw_provider` | openai |
| `raw_model` | gpt-4.1 |
| `raw_created_utc` | 2026-06-23T051804Z |
| `raw_run_id` | order004 |
...
An e-learning company needs to batch generate vector embeddings for newly uploaded course transcripts. Which AWS service combination best automates this embedding workflow for scale and flexibility?

Options:

1. S3 event triggers to invoke AWS Lambda functions, which call the embedding API for each new transcript.
2. EC2 instances polling S3 and writing results to DynamoDB.
3. Manual embedding generation via SageMaker Studio notebooks.
4. Amazon QuickSight for pipeline automation.

Correct answer: S3 event triggers to invoke AWS Lambda functions, which call the embedding API for each new transcript.

Rationale: This event-driven approach leverages AWS-native automation, scaling, and flexibility, automating processing as new data arrives.

Distractors: EC2 instances polling S3 and writing results to DynamoDB.: EC2 polling is operationally burdensome, lacks event-driven scaling, and is more complex to manage.; Manual embedding generation via SageMaker Studio notebooks.: Manual notebooks do not scale or automate routine embedding generation.; Amazon QuickSight for pipeline automation.: QuickSight is for analytics and visualization, not for building scalable embedding pipelines.

Misconception tags: Confusing analytics with embedding pipelines; Favoring manual steps over event-driven automation

Source trace:

AWS Lambda with S3 Event triggers documentation; embedding workflow examples

Remediation target:

docs/Pilot1/aip-c01/student-kit/accelerated-7-day/day-02-artifacts/day02-order004-embeddings-vector-similarity.md

Generation notes: Scenario: Batch pipeline with new data; review event-driven Lambda embedding workflow for scalability.

### P1-AIP-D2-N042

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N042 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario: Degraded performance at scale; check root cause relating to model selection and embedding suitability.

### P1-AIP-D2-N043

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N043 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario: Metric selection misconceptions; Reviewer should confirm true dependence on model metric compatibility.

### P1-AIP-D2-N044

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N044 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario: Secure vector storage; reviewer should confirm security boundary for embeddings.

### P1-AIP-D2-N045

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N045 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario: Compare model performance by domain fit; reviewer should confirm rationale for domain-tuned embeddings.

### P1-AIP-D2-N046

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N046 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario: Omitted new documents; reviewer should verify embedding vs. indexing workflow separation.

### P1-AIP-D2-N047

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N047 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario: Contextual ambiguity in embedding search; reviewer should validate focus on embedding model/prompt context.

### P1-AIP-D2-N048

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N048 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario: Chatbot support with varied queries; Reviewer should check alignment between model training and required conversational breadth.

### P1-AIP-D2-N049

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N049 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario: Financial context, semantic optimization. Reviewer inspect dimension/relevance vs. operational practices.

### P1-AIP-D2-N050

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N050 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario: Hospital EMR across languages; Reviewer should confirm true risks for rare term and cross-language embedding consistency.

### P1-AIP-D2-N051

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N051 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Tests scenario around mixed document types; watch for distractors conflating chunk size with chunking strategy.

### P1-AIP-D2-N052

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N052 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Focuses on a common real-world failure mode; reviewer should validate if chunking boundary impact is best causal explanation.

### P1-AIP-D2-N053

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N053 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario uses structured legal documents; review distractors for plausibility and scenario alignment.

### P1-AIP-D2-N054

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N054 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Reviews excessive overlap scenario; validate overlap/cost relationships.

### P1-AIP-D2-N055

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N055 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Tests adaptivity for mixed-length documents; reviewers check rationale for adaptive strategies.

### P1-AIP-D2-N056

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N056 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Focuses on semantic loss due to character-based chunking.

### P1-AIP-D2-N057

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N057 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Academic paper scenario; reviewer to check rationale around overlap vs. structure.

### P1-AIP-D2-N058

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N058 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Optimizes for both precision and retrieval; verify rationale distinguishes between overlap utility and dangers.

### P1-AIP-D2-N059

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N059 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Mixed-document-type scenario; tests knowledge of adaptive chunking.

### P1-AIP-D2-N060

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N060 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Tests multilingual and mixed-length challenge; reviewer to check all three correct meet scenario constraint.

### P1-AIP-D2-N061

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N061 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario: balancing retrieval vs. resource cost after pipeline tuning.

### P1-AIP-D2-N062

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N062 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Life sciences scenario tests adaptive vs. rigid chunking in highly heterogeneous corpus.

### P1-AIP-D2-N063

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N063 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
...
Generation notes: Scenario tests metadata as filtering/security, not bulk decoration. Reviewer should check trap and FM search boundary clarity.

### P1-AIP-D2-N064

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N064 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Scenario tests procedural filter config. Reviewer should inspect if semantic/keyword traps are plausible.

### P1-AIP-D2-N065

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N065 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests direct conditional/filtering impact of metadata. Reviewer: check distractor clarity on compliance-control trap.

### P1-AIP-D2-N066

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N066 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Demands correct use of custom metadata field in retrieval. Reviewer: validate RAG and OpenSearch linkage.

### P1-AIP-D2-N067

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N067 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Explains metadata's role in access control. Reviewer: check scenario plausibility and filter-vs-embedding traps.

### P1-AIP-D2-N068

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N068 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Explains function of tags; reviewer should check it does not imply tags alter embeddings.

### P1-AIP-D2-N069

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N069 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Scenario tests multi-attribute metadata. Reviewer to check file path and free-text field as plausible but inaccurate options.

### P1-AIP-D2-N070

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N070 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests compliance/retention filtering. Reviewer may check manual and in-text options as plausible but unsound.

### P1-AIP-D2-N071

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N071 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests variant-level metadata tag utility. Reviewer: check plausibility of semantic similarity and title-only traps.

### P1-AIP-D2-N072

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N072 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests structured metadata for multi-attribute filtering. Reviewer: validate 'blob' and 'free-text' distractor traps.

### P1-AIP-D2-N073

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N073 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Pinpoints filter/ranking metadata for retrieval freshness; reviewer to inspect distractor clarity.

### P1-AIP-D2-N074

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N074 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests attribute-based security filtering in retrieval. Reviewer: confirm plausible traps around text-only and auth-only.

### P1-AIP-D2-N075

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N075 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Scenario focuses on managed hierarchy and minimal custom code. Reviewer should check the alignment of Bedrock Knowledge Bases features.

### P1-AIP-D2-N076

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N076 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Blended semantic+keyword required. Reviewer should verify Bedrock Knowledge Base capabilities and OpenSearch feature integration.

### P1-AIP-D2-N077

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N077 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests understanding of vector index and embedding dimension dependence. Reviewer should verify OpenSearch/Neural requirements.

### P1-AIP-D2-N078

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N078 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Focus on latency, real-time, and custom ranking. Reviewer should validate OpenSearch vs. DynamoDB semantics.

### P1-AIP-D2-N079

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N079 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Focus on security and extensibility. Reviewer should check that metadata filtering and managed stores are highlighted correctly.

### P1-AIP-D2-N080

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N080 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Focus on managed scaling and analytics integration. Reviewer should check OpenSearch/Bedrock integration details.

### P1-AIP-D2-N081

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N081 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Maximizes managed service integration and minimizes custom code. Reviewer should check vector store support for both text and image metadata use cases.

### P1-AIP-D2-N082

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N082 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Highlights importance of managed indexing and database-layer security. Reviewer to check accuracy of constraint-driven eliminations.

### P1-AIP-D2-N083

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N083 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests managed service tradeoff. Reviewer to check on OpenSearch plugin management in AWS.

### P1-AIP-D2-N084

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N084 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Reviewer should check audit/control integration and scalability of RAG workflows with Bedrock Knowledge Bases.

### P1-AIP-D2-N085

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N085 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
| `last_reviewed` | not-reviewed |
| `source_trace_status` | needs-source-check |
| `raw_source` | 2026-06-23T052016Z-openai-gpt-4.1-day-02-order007.md item 11 |
| `raw_provider` | openai |
| `raw_model` | gpt-4.1 |
| `raw_created_utc` | 2026-06-23T052016Z |
| `raw_run_id` | order007 |
...
Your product search platform needs to perform hybrid searches that blend both semantic and keyword search capabilities. Which AWS solution offers the best foundation for this use case?

Options:

1. Amazon OpenSearch Service with Neural plugin
2. Amazon DynamoDB with custom Lambda-powered filters
3. Amazon RDS with pgvector extension
4. Amazon S3 with Athena querying over embedding files

Correct answer: Amazon OpenSearch Service with Neural plugin

Rationale: OpenSearch Service with Neural plugin is purpose-built for hybrid semantic/keyword search, combining vector similarity and traditional term search in one query pipeline.

Distractors: Amazon DynamoDB with custom Lambda-powered filters: DynamoDB does not support hybrid search natively; complex workarounds are required for keyword and vector search integration.; Amazon RDS with pgvector extension: Pgvector enables vector similarity search, but lacks full-text or keyword search natively.; Amazon S3 with Athena querying over embedding files: Athena is not designed for either high-performance semantic or keyword search.

Misconception tags: Thinking DynamoDB or Athena can easily support hybrid search; Confusing extension with built-in capabilities
...
Generation notes: Hybrid search is a common requirement. Reviewer must ensure Neural/OpenSearch hybrid support is current.

### P1-AIP-D2-N086

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N086 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests use of metadata and hierarchical query support. Reviewer to verify current Bedrock KB support for metadata-based filtering.

### P1-AIP-D2-N087

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N087 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Scenario focuses on improper shard configuration. Reviewer should check OpenSearch docs for single-shard query routing.

### P1-AIP-D2-N088

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N088 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Scenario tests index isolation best practice. Reviewer should assess AWS recommendation of multi-index for distinct domains.

### P1-AIP-D2-N089

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N089 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Scenario focuses on update efficiency and index freshness. Reviewer should check guidance on incremental index maintenance.

### P1-AIP-D2-N090

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N090 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests diagnosis of node resource exhaustion. Reviewer to confirm OpenSearch best practices for scaling.

### P1-AIP-D2-N091

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N091 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests region-aware vector store design. Reviewer should confirm with AWS OpenSearch regional deployment guidance.

### P1-AIP-D2-N092

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N092 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Focus on automated freshness. Reviewer should verify source on incremental update and change detection patterns.

### P1-AIP-D2-N093

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N093 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests recognition of shard imbalance. Reviewer needs to verify OpenSearch scaling best practices.

### P1-AIP-D2-N094

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N094 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests scalable and maintainable design. Reviewer should verify OpenSearch multi-index recommendations.

### P1-AIP-D2-N095

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N095 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests search bottleneck avoidance. Reviewer verify which OpenSearch node roles handle queries.

### P1-AIP-D2-N096

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N096 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Tests multi-statement scaling. Reviewer inspect for overleveraging replica design.

### P1-AIP-D2-N097

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N097 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Multiple-response focus on cross-team isolation. Reviewer should check for sharding risks and correct scaling policies.

### P1-AIP-D2-N098

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N098 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Focuses on ineffective scaling. Reviewer verify that replicas without more primaries cannot address primary hot spots.

### P1-AIP-D2-N099

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N099 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.4: Design and implement vector store solutions. |
...
Generation notes: Exam-plus item. Scenario revolves around poor shard management. Reviewer check sharding guidance at high scale.

### P1-AIP-D2-N100

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N100 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario targets embedding quality; reviewer to inspect technical distinction between model fine-tuning and embedding domain fit.

### P1-AIP-D2-N101

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N101 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario targets vector vs. keyword approaches; reviewer to check Bedrock KBs provide semantic vector search, not just metadata.

### P1-AIP-D2-N102

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N102 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario targets semantic search meaning vs. keywords; reviewer to inspect clarity on boundaries and what semantic retrieval does not solve.

### P1-AIP-D2-N103

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N103 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario pushes domain fit; reviewer should check for clear link between embedding domain and semantic retrieval.

### P1-AIP-D2-N104

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N104 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Tests clear vector vs. keyword distinction; reviewer to verify focused rationale on semantic similarity.

### P1-AIP-D2-N105

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N105 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Multi-response, tests procedural config vs. operational add-ons. Reviewer to check distractor plausibility.

### P1-AIP-D2-N106

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N106 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Examines how vector search handles out-of-scope queries. Reviewer to inspect for accuracy in search pipeline side effects.

### P1-AIP-D2-N107

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N107 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Tests combining access control, semantic similarity, and architectural best practices. Reviewer should confirm best-practice stack.

### P1-AIP-D2-N108

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N108 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Multi-response, addresses advanced tuning. Reviewer to inspect mapping to documented relevance improvements.

### P1-AIP-D2-N109

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N109 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Targets chunking granularity. Reviewer to verify distractors are realistic but less effective.

### P1-AIP-D2-N110

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N110 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Exam-plus: Troubleshooting up-to-date data retrieval. Reviewer should check explanations for embedding-refresh as root cause.

### P1-AIP-D2-N111

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N111 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Multi-response config checklist. Reviewer to ensure distractors reflect plausible but non-essential options.

### P1-AIP-D2-N112

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N112 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
| `last_reviewed` | not-reviewed |
| `source_trace_status` | needs-source-check |
| `raw_source` | 2026-06-23T052302Z-openai-gpt-4.1-day-02-order010.md item 1 |
| `raw_provider` | openai |
| `raw_model` | gpt-4.1 |
...
1. Configure the solution to use the Model Context Protocol (MCP) client to orchestrate vector queries and return top-k context chunks through a standardized API.
2. Add a Lambda function that scrapes all documents in S3 and passes all content in a batch to the FM via REST.
3. Enable synchronous search in Amazon Bedrock by directly exposing Knowledge Base search endpoints to client applications.
4. Set up the FM to invoke a retriever chain using event-driven Step Functions on every query.

Correct answer: Configure the solution to use the Model Context Protocol (MCP) client to orchestrate vector queries and return top-k context chunks through a standardized API.

Rationale: Using the MCP client standardizes and automates the retrieval of top-k chunks. It is purpose-built to connect vector stores to FMs, ensuring seamless, reliable access to the most relevant context data via API.

Distractors: Add a Lambda function that scrapes all documents in S3 and passes all content in a batch to the FM via REST.: Tempting because Lambda is flexible, but it is not scalable or context-aware. Passing all content can overwhelm inference and wastes resources.; Enable synchronous search in Amazon Bedrock by directly exposing Knowledge Base search endpoints to client applications.: This exposes backend infrastructure directly to clients, breaking abstraction and may bypass necessary formatting/filtering logic.; Set up the FM to invoke a retriever chain using event-driven Step Functions on every query.: Using Step Functions for every query adds unnecessary latency and orchestration overhead for a basic retrieval step, versus using a direct protocol like MCP.

Misconception tags: Assuming all context must be sent to FM; Confusing orchestration with standardized retrieval
...
Generation notes: Scenario emphasizes architecture constraint. Reviewer should check if MCP-client usage is properly supported for described API interaction.

### P1-AIP-D2-N113

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N113 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Focuses on maintainability and interface standardization. Reviewer should confirm best practice for decoupling in RAG.

### P1-AIP-D2-N114

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N114 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario tests core RAG maintenance challenge. Reviewer to verify synchronization as correct root cause.

### P1-AIP-D2-N115

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N115 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Tests security vs. architecture layering. Reviewer should check that metadata filtering is best-practice.

### P1-AIP-D2-N116

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N116 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
| `last_reviewed` | not-reviewed |
| `source_trace_status` | needs-source-check |
| `raw_source` | 2026-06-23T052302Z-openai-gpt-4.1-day-02-order010.md item 5 |
| `raw_provider` | openai |
| `raw_model` | gpt-4.1 |
| `raw_created_utc` | 2026-06-23T052302Z |
| `raw_run_id` | order010 |
...
A developer needs to design a RAG solution integrating with Amazon Bedrock and a managed vector store. The business case requires minimal custom code for context retrieval and high developer productivity. Which approach best achieves this?

Options:

1. Use the function calling interface supported by Bedrock, connecting to the managed vector store using a standardized API pattern.
2. Build a custom context retriever as a managed Lambda function that accesses the vector store on each FM invocation.
3. Integrate vector retrieval logic within application containers managed by ECS.
4. Directly expose vector database query endpoints to the FM, bypassing orchestration layers.

Correct answer: Use the function calling interface supported by Bedrock, connecting to the managed vector store using a standardized API pattern.

Rationale: Function calling in Bedrock with a standardized API reduces the need for custom integration code and leverages Bedrock's managed capabilities.

Distractors: Build a custom context retriever as a managed Lambda function that accesses the vector store on each FM invocation.: Custom Lambda functions increase maintenance and complexity compared to using the provider's direct integrations.; Integrate vector retrieval logic within application containers managed by ECS.: Embedding retrieval logic in containers is more complex and not necessary if Bedrock supports standardized integration.; Directly expose vector database query endpoints to the FM, bypassing orchestration layers.: FM models cannot consume raw vector database queries and require orchestration or formatting layers.

Misconception tags: Confusing custom orchestration as a requirement; Overlooking managed integrations
...
Generation notes: Emphasizes developer productivity and managed services preference.

### P1-AIP-D2-N117

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N117 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Tests common architecture misunderstanding regarding the FM’s system boundary.

### P1-AIP-D2-N118

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N118 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
| `last_reviewed` | not-reviewed |
| `source_trace_status` | needs-source-check |
| `raw_source` | 2026-06-23T052302Z-openai-gpt-4.1-day-02-order010.md item 7 |
| `raw_provider` | openai |
| `raw_model` | gpt-4.1 |
| `raw_created_utc` | 2026-06-23T052302Z |
| `raw_run_id` | order010 |
...
A company is designing a RAG workflow to support product-question answering using Bedrock and its managed Knowledge Base. Which options are best practices for consistent, seamless integration between the Foundation Model and the retrieval system? (Select TWO.)

Options:

1. Leverage Bedrock’s function-calling interface to obtain top relevant chunks for the FM prompt.
2. Use MCP-compliant clients to abstract vector queries and standardize data flow to the FM.
3. Allow the FM to parse entire document sets directly as part of each inference.
4. Build a context retriever using Lambda functions that bypass all Bedrock orchestration.
5. Implement API integration for retrieval context that is model-agnostic and repeatable.

Correct answer: Leverage Bedrock’s function-calling interface to obtain top relevant chunks for the FM prompt.; Use MCP-compliant clients to abstract vector queries and standardize data flow to the FM.

Rationale: Function-calling interfaces and MCP-compliant clients are both recommended for standardized, consistent context retrieval in RAG architectures, decoupling retrieval logic from model specifics.

Distractors: Allow the FM to parse entire document sets directly as part of each inference.: Doing so is wasteful, unscalable, and exceeds FM input limits.; Build a context retriever using Lambda functions that bypass all Bedrock orchestration.: Bypassing Bedrock’s orchestration negates advantages of managed, standardized integration.; Implement API integration for retrieval context that is model-agnostic and repeatable.: Tempting, but on its own too generic unless built using MCP or function-calling frameworks.

Misconception tags: Assuming batch loading documents is scalable or necessary; Bypassing managed frameworks
...
Generation notes: Tests multiple integration best-practices. Reviewer to check current documentation for MCP/Function Calling support.

### P1-AIP-D2-N119

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N119 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Tests implementation-first integration steps. Reviewer to verify chunking as the foundational step.

### P1-AIP-D2-N120

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N120 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Judges cost-control via optimal retrieval. Reviewer to check Bedrock API’s top-k tuning description.

### P1-AIP-D2-N121

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N121 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
| `last_reviewed` | not-reviewed |
| `source_trace_status` | needs-source-check |
| `raw_source` | 2026-06-23T052302Z-openai-gpt-4.1-day-02-order010.md item 10 |
| `raw_provider` | openai |
| `raw_model` | gpt-4.1 |
| `raw_created_utc` | 2026-06-23T052302Z |
| `raw_run_id` | order010 |
...
A customer’s RAG deployment yields inconsistent results. Sometimes the FM answers correctly, but at other times it ignores highly relevant source material. Which issues could cause this behavior? (Select TWO.)

Options:

1. Context chunking is not aligned with natural information boundaries, causing loss of key details.
2. Vector search retrieves too many irrelevant chunks due to poor query tuning.
3. The FM’s underlying architecture does not support function calling.
4. APIs return results in JSON format, which the FM cannot interpret.
5. Document embeddings are generated using inconsistent preprocessing pipelines.

Correct answer: Context chunking is not aligned with natural information boundaries, causing loss of key details.; Document embeddings are generated using inconsistent preprocessing pipelines.

Rationale: Chunking that ignores logical boundaries can omit or mangle context. Inconsistent embeddings create semantic mismatch, so relevant documents may not be retrieved.

Distractors: Vector search retrieves too many irrelevant chunks due to poor query tuning.: Tempting, but irrelevant chunks often lead to noisy but not missing answers. The core is quality of retrieval and embeddings.; The FM’s underlying architecture does not support function calling.: If function calling is unsupported, RAG would not function at all, rather than returning inconsistent results.; APIs return results in JSON format, which the FM cannot interpret.: Standard protocols ensure FMs can receive pre-formatted context, so this is rarely the actual source.

Misconception tags: Confusing retrieval output format with chunk/content relevance; Misunderstanding the root causes of inconsistent FM answers
...
Generation notes: Multiple-response targets RAG failure symptom diagnosis.

### P1-AIP-D2-N122

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N122 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
| `last_reviewed` | not-reviewed |
| `source_trace_status` | needs-source-check |
| `raw_source` | 2026-06-23T052302Z-openai-gpt-4.1-day-02-order010.md item 11 |
| `raw_provider` | openai |
| `raw_model` | gpt-4.1 |
| `raw_created_utc` | 2026-06-23T052302Z |
| `raw_run_id` | order010 |
...
While supporting multiple RAG client applications, a central platform team needs all integrations to be reliable and future-proof. Which practices support these goals? (Select TWO.)

Options:

1. Standardize API contract for retrieval callbacks regardless of FM implementation.
2. Document model-specific input formatting assumptions inside every retrieval handler.
3. Use only function-calling-compatible interfaces for retrieval orchestration.
4. Embed all vector store credentials within the FM prompt for dynamic connection.
5. Require retrieval endpoints to conform to MCP protocol for all client integrations.

Correct answer: Standardize API contract for retrieval callbacks regardless of FM implementation.; Require retrieval endpoints to conform to MCP protocol for all client integrations.

Rationale: API standardization and MCP protocol support maximize reliability and interoperability across applications and evolving FMs.

Distractors: Document model-specific input formatting assumptions inside every retrieval handler.: This adds complexity and couples retrieval handlers too closely with FMs.; Use only function-calling-compatible interfaces for retrieval orchestration.: Function calling is useful, but protocol-enforced compatibility brings more reliability across FMs.; Embed all vector store credentials within the FM prompt for dynamic connection.: Credentials should never be placed in the prompt or inference payloads.

Misconception tags: Belief in hardcoding model-dependent logic; Credential-handling; Protocol confusion
...
Generation notes: Multiple-response highlights cross-team integration and future-proofing.

### P1-AIP-D2-N123

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N123 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Tests tuning and context-size tradeoff. Reviewer should confirm the Bedrock API tuning options are current.

### P1-AIP-D2-N124

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N124 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Tests latency tuning and topical prioritization. Reviewer to verify top-k's effect on Bedrock RAG pipeline.

### P1-AIP-D2-N125

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N125 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Focused on future-provider portability; reviewer should validate that the scenario avoids service-name lookup and risky claims.

### P1-AIP-D2-N126

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N126 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: This item focuses on request parameterization for retrieval; reviewer should check clarity regarding context-source ambiguity.

### P1-AIP-D2-N127

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N127 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Tests extensibility, modularity, and correct use of APIs; reviewer should ensure distractors clearly separate extensibility from mere format standardization.

### P1-AIP-D2-N128

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N128 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.5: Design retrieval mechanisms for FM augmentation. |
...
Generation notes: Scenario focuses on compliance/citation needs in RAG; reviewer should verify prompt does not hinge on service capability, but on architecture.

### P1-AIP-D2-N129

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N129 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Focuses on data variability, not trivia; scenario constraint is cross-modal context preservation; check that the official artifact covers ordering and metadata as critical in preprocessing for multimodal FMs.

### P1-AIP-D2-N130

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N130 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Scenario highlights inconsistent formats and quality; stem tests audio normalization vs trivial grouping or direct model use.

### P1-AIP-D2-N131

| Field | Value |
|---|---|
| `item_id` | P1-AIP-D2-N131 |
| `status` | draft |
| `official_exam_code` | AIP-C01 |
| `exam_domain` | Content Domain 1: Foundation Model Integration, Data Management, and Compliance |
| `exam_task` | Task 1.3: Implement data validation and processing pipelines for FM consumption. |
...
Generation notes: Scenario is complex, multimodal, and legal-context; focus on preprocessing controls over manual or augmentation steps.
